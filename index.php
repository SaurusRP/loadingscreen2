...
$SteamAPIKey = "A5ECC69197E3FFF38AA9E752451C3263";
    ...
    <div class="core-wrapper"><!-- Opens the wrapper so we can contain and center everything -->
    	...
    	<div id="left-items"><!-- Opens the wrapper for the left content, there isn't really much to change on the left side as it's dynamic -->
            ...
            <div class="title server">
            	<h2>Server Information</h2><!-- Adds in the server title, you can change the text to be whatever you would like -->
           	</div>
        ...
        <div id="right-items"><!-- Open wrapper for the items on the right -->
            ...
            <div class="title">
            	<h2>Server Rules</h2><!-- Adds in the rules title, you can change the text to be whatever you would like -->
           	</div>
            
            <!-- Let's add in all the rules, the number inside the <span></span> tags will appear in a brighter coloured box  -->
            <ul id="rules">
            	<li><span>1</span> Place all your rules</li>
                <li><span>2</span> Do Not RDM</li>
                <li><span>3</span> Do Not propkill</li>
                <li><span>4</span> Do Not Metagame</li>
                <li><span>5</span> Do Not Hack / Cheat</li>
                <li><span>6</span> Do Not Kill Players With Planes</li>
                <li><span>7</span> Do Not Request Ranks</li>
                <li><span>8</span> Donations Are Handled Staff</li>
                <li><span>9</span> Obey all staff orders</li>
                <li><span>10</span> Staff Decisions are final</li>
                <li><span>11</span> Respect all other players</li>
            </ul>
